"reaction rate constants, some depends on temperature."
...
"initial flowrate at cavity entrance"
function initial_flowrate(fr_inlet; diss_I₂, utl_Cl₂)
    (; Cl₂, I₂, He_P, He_S, H₂O) = fr_inlet
    He = He_P + He_S
    O₂ = Cl₂ * utl_Cl₂
    I = 2 * I₂ * diss_I₂
    Cl₂ = Cl₂ * (1 - utl_Cl₂)
...
function gas_mix(flowrate)
    ...
    gas_df = DataFrame(
        ...
        γₚ = [5.7, 0, 0, 0, 0, 4.1] * u"MHz/Torr",      # source: https://doi.org/10.1021/jp014690k
